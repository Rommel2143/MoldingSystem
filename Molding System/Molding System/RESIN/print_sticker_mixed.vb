...
Public Class print_sticker_mixed
    Dim category As String = "M"
    ...
    Private Sub txtqr_TextChanged(sender As Object, e As EventArgs) Handles txtqr_v.TextChanged

    End Sub

    Private Sub txtqr_KeyDown(sender As Object, e As KeyEventArgs) Handles txtqr_v.KeyDown
        Try
            ' Split the QR code

            Dim parts() As String = txtqr_v.Text.Split("|"c)

            ' Check if the split result has the correct length
            If parts.Length >= 3 Then
                Dim partcode1 As String = parts(0).Trim()
                Dim qty As Decimal = parts(1).Trim()
                Dim category As String = parts(2).Trim()
                Dim series As String = parts(3).Trim()

                If category = "V" Then
                    check_v.Visible = True
                Else
                    check_v.Visible = False
                End If
            End If
    ...
    Private Sub Guna2TextBox1_TextChanged(sender As Object, e As EventArgs) Handles txtqr_r.TextChanged

    End Sub

    Private Sub Guna2TextBox1_KeyDown(sender As Object, e As KeyEventArgs) Handles txtqr_r.KeyDown
        Try
            ' Split the QR code

            Dim parts() As String = txtqr_r.Text.Split("|"c)

            ' Check if the split result has the correct length
            If parts.Length >= 3 Then
                Dim partcode2 As String = parts(0).Trim()
                Dim qty As Decimal = parts(1).Trim()
                Dim category As String = parts(2).Trim()
                Dim series As String = parts(3).Trim()
    ...
    Private Sub Guna2Button1_Click(sender As Object, e As EventArgs) Handles Guna2Button1.Click
        If partcode1 = partcode2 Then
            panel_create.Enabled = True
        Else
            panel_create.Enabled = False
            MessageBox.Show("Material not Equal")
        End If
    End Sub
End Class