...
Public Class Recycled_IN
        ...
        Try
            ...
            If parts.Length >= 3 Then
                ...
                If category = "R" Then
                    ...
                    Dim selectdata As New MySqlCommand("SELECT resinid, serialno FROM molding_resin_recycled WHERE resinid=@resinid AND serialno=@serialno", con)
                    ...
                    Else
                        ...
                        Dim selectcmd As New MySqlCommand("INSERT INTO `molding_resin_recycled`(`resinid`, `serial_code`, `serialno`,qty,userin ,`datein`)
    ...
    Private Sub txtqr_matrix_KeyDown(sender As Object, e As KeyEventArgs) Handles txtqr.KeyDown
        If e.KeyCode = Keys.Enter Then
            ...
            reload("SELECT rm.partcode, rv.serialno FROM molding_resin_recycled rv
